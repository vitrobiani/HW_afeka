...
public class Answer implements Serializable{
	...
	public String getAnswer() {
		if (type == eType.close) {
			return AR.getSpecifcClosedAns(AnswerIndex);
		} else {
			return AR.getSpecifcOpenAns(AnswerIndex);
		}
	}

	public String toString() {
		StringBuffer sB = new StringBuffer();
		sB.append("the answer: " + (type == eType.open) != null ? AR.getSpecifcOpenAns(AnswerIndex)
				: AR.getSpecifcClosedAns(AnswerIndex) + '\n' + "it is: " + (isCorrect) != null ? "correct"
						: "incorrect" + '\n' + "its type is: " + type);
